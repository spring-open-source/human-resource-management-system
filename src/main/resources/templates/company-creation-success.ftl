  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
                    <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">Company Added!</h1>
<table class="s-1 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #003166; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#cce5ff">
        <div align="center">Company Name: <span class="font-weight-bold" style="font-weight: bold !important;">${companyName}</span>
</div>
      </td>
    </tr>
  </tbody>
    ...
    <tbody>
      <tr>
        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;" align="left"></td>
                    ...
                    <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Congratulations ${firstName}, on successfully registering your company with Flenderson: Human Resource Management System.</h5>
                    <div class="hr " style="width: 100%; margin: 20px 0; border: 0;">
  <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
    <tbody>
      <tr>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #003166; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#cce5ff">
        <div align="center">Company Code: <span class="font-weight-bold" style="font-weight: bold !important;">${companyCode}</span>
</div>
      </td>
    </tr>
  </tbody>
...
<h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">
                        Now, Please proceed to share this unique code generated for your company ${companyName}, Your Employees will be available to join the company's portal through this code, So Please handle it with care.
                    </h5>
                    <table class="s-1 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<h5 align="center" class="text-muted font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">You'll still be able to Accept/Reject Joining Invitations.</h5>
                    <div align="center">
                        <table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#007bff">
        <a href="" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #007bff; color: #ffffff; padding: 8px 12px; border: 1px solid #007bff;">Get Started</a>
      </td>
    </tr>
  </tbody>
</table>
