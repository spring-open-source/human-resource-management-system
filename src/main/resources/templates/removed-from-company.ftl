  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
              <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">Kicked Out Of Company!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
               ...
               <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Hello ${firstName}, You have been kicked out of ${companyName}, This Was done by HR Manager ${managerName}.</h5>
...
<h5 class="text-muted  " align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">You will be unable to view the company's activity on your console from now.</h5>
<table class="s-1 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="4" style="border-spacing: 0px; border-collapse: collapse; line-height: 4px; font-size: 4px; width: 100%; height: 4px; margin: 0;" align="left">
    ...
    <tbody>
      <tr>
        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;" align="left"></td>
              ...
              <div class="text-muted" align="center" style="color: #636c72;">If you think this was done in error, please take the conversation with your HR Manager outside the Flenderson Environment.</div>
              <div align="center">
				<table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
