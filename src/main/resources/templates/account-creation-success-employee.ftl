  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #6d5200; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#fff4d3">
        <div align="center">
                  Join With Your Company's Code Now!!
               </div>
      </td>
    </tr>
  </tbody>
...
<h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Now, that you've completed the first step, you are one click away from joining your colleagues on <span class="font-weight-bold" style="font-weight: bold !important;">Flenderson</span>, Contact your Human Resource Manager now and ask them for your company's <span class="font-weight-bold" style="font-weight: bold !important;">code</span>, It's that simple.</h5>
               <div align="center">
                  <table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#ffc107">
        <a href="" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #ffc107; color: #111111; padding: 8px 12px; border: 1px solid #ffc107;">Get Started</a>
      </td>
    </tr>
  </tbody>
</table>
