  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
              <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">Joining Request Sent!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
               ...
               <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Hello ${firstName}, Your request to join ${companyName} has been successfully sent to the HR Manager.</h5>
              <div align="center">
                <table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<img class="img-fluid photo " src="https://images.pexels.com/photos/2787214/pexels-photo-2787214.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500" style="height: 420px; line-height: 100%; outline: none; text-decoration: none; width: 280px; max-width: 100%; border: 0 none;">
              </div>
...
<h5 class="text-muted " align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Here's hoping your manager ain't lazy and you are a valid employee.</h5>
            </div>
      </td>
    </tr>
  </tbody>
