  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
              <h1 align="center" class="font-weight-bold  text-white" style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; color: #ffffff;">Joining Request Accepted!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
               ...
               <h5 class="text-white" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #ffffff;">Hello ${firstName}, Your request to join ${companyName} has been confirmed by your HR Manager ${managerName}.</h5>
...
<img class="img-fluid photo " src="https://images.pexels.com/photos/3959482/pexels-photo-3959482.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500" style="height: 400px; line-height: 100%; outline: none; text-decoration: none; width: 280px; max-width: 100%; border: 0 none;">
              </div>
              <div class="hr " style="width: 100%; margin: 20px 0; border: 0;">
  <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
    <tbody>
