  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
          <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">Monthly Attendance Report!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
          ...
          <h5 class="text-muted " align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Hey {managerName}, The Monthly Attendance Report For the month ${month} for your company ${companyName} is here, generated by Flenderson: Human Resource Management System.</h5>
    ...
    <tr>
      <td height="8" style="border-spacing: 0px; border-collapse: collapse; line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;" align="left">
         
          ...
          <div align="center">
            <img class="photo" src="https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500" style="height: 500px; line-height: 100%; outline: none; text-decoration: none; width: 350px; border: 0 none;">
         <div class="hr bg-primary" style="width: 100%; background-color: #007bff; margin: 20px 0; border: 0;">
