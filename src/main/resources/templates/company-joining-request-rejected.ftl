  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
              <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">Joining Request Rejected!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
               ...
               <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Hello ${firstName}, Your request to join ${companyName} has been Rejected by your HR Manager ${managerName}.</h5>
...
<img class="img-fluid photo " src="https://i.redd.it/w38kq83igyy01.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
              </div>
              <div class="hr " style="width: 100%; margin: 20px 0; border: 0;">
  <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
    <tbody>
...
<h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">If you think this was done in error, please take the conversation with your HR Manager outside the Flenderson Environment.</h5>
              <div align="center">
              </div>
            </div>
      </td>
