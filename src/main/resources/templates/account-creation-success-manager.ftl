    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
               ...
               <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Congratulations!, on successfully creating your account with Flenderson: Human Resource Management System.</h5>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #66121a; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#fae3e5">
        <div align="center">
                  Register Your Company Now For Free!!
               </div>
      </td>
    </tr>
  </tbody>
...
<h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Register your Company and Generate your company <span class="font-weight-bold" style="font-weight: bold !important;">code </span>and start sending invites to the employees and begin managing them through our system efficiently in minutes</h5>
               <div align="center">
                  <table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<table class="btn btn-danger " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#dc3545">
        <a href="" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #dc3545; color: #ffffff; padding: 8px 12px; border: 1px solid #dc3545;">Start Now</a>
      </td>
    </tr>
  </tbody>
</table>
