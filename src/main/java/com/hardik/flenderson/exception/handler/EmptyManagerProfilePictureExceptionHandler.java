...
public class EmptyManagerProfilePictureExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(EmptyManagerProfilePictureException.class)
