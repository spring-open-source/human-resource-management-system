...
public class MissingAccessTokenAndUserIdExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(MissingAccessTokenAndUserIdException.class)
