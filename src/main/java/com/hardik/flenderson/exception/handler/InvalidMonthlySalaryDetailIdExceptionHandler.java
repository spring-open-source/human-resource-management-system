...
public class InvalidMonthlySalaryDetailIdExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(InvalidMonthlySalaryDetailIdException.class)
