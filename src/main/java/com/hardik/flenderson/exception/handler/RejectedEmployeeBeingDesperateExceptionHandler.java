...
public class RejectedEmployeeBeingDesperateExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(RejectedEmployeeBeingDesperateException.class)
