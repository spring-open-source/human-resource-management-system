...
public class InvalidCompanyCodeAndNameExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(InvalidCompanyCodeAndNameException.class)
