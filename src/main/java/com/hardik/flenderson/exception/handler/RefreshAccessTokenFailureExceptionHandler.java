...
public class RefreshAccessTokenFailureExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(RefreshAccessTokenFailureException.class)
