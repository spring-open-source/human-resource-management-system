...
public class KeycloakCodeExchangeFailureExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(KeycloakCodeExchangeFailureException.class)
