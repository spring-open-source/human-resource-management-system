...
public class AuthenticationBearerStrategyNotUsedExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(AuthenticationBearerStrategyNotUsedException.class)
