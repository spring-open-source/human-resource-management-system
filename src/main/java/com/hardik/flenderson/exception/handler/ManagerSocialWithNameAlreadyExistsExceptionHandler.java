...
public class ManagerSocialWithNameAlreadyExistsExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(ManagerSocialWithNameAlreadyExistsException.class)
