...
public class CompanyJoinInvitationAlreadySentExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(CompanyJoinInvitationAlreadySentException.class)
