...
public class EmployeeSocialWithNameAlreadyExistsExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(EmployeeSocialWithNameAlreadyExistsException.class)
